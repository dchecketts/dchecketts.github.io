...
This series will serve as an introduction to HTML, and works in conjunction with the CSS series and JavaScript series to build a basic web journal with the ability to save and load content.
